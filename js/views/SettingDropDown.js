define(['./Container','Cesium'],function(Container,Cesium){
    ...
    var htmlStr = [
               ...
               '<div><div class="squaredTwo" id="atomsphereRender"><input type="checkbox" checked=""><label class="check-icon"></label></div><label>' + "大气渲染" + '</label></div>',
               '<div><div class="squaredTwo" id="lightRender"><input type="checkbox" checked=""><label class="check-icon"></label></div><label>' + "光照渲染" + '</label></div>',
               '<div><div class="squaredTwo" id="fogEnabled"><input type="checkbox" checked=""><label class="check-icon"></label></div><label>' + "雾化效果" + '</label></div>',
               "</div>"
               ].join('');
